...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_BRANCH_VIEW, MNTS_B | MNTS_I | MNTS_A, CM_LEFT_BRANCHVIEW, -1, 0, NULL},
        ...
        {MNTT_PE},
        {MNTT_IT, IDS_BRANCH_OPENPARENT, MNTS_B | MNTS_I | MNTS_A, CM_BRANCH_OPENPARENT, IDX_TB_PARENTDIR, 0, NULL},
        {MNTT_IT, IDS_BRANCH_STOP, MNTS_B | MNTS_I | MNTS_A, CM_BRANCH_STOP, -1, 0, NULL},
        ...
        {MNTT_IT, IDS_MENU_BRANCH_VIEW, MNTS_B | MNTS_I | MNTS_A, CM_RIGHT_BRANCHVIEW, -1, 0, NULL},
