...
| --- | --- | --- |
| Total Commander | Branch View behavior | Inspired by the recursive flat-view workflow in [Total Commander](https://www.ghisler.com/) by Ghisler Software GmbH. Independent implementation; no Total Commander source code is included. |
